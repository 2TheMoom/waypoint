...
```bash
# Linting
genvm-lint check contracts/waypoint.py         # Lint the contract
...
**Frontend stack**: Next.js 16, React 19, TypeScript, Tailwind CSS v4, TanStack Query, MetaMask wallet integration.

## Development Workflow

1. Write/modify contract in `contracts/`
2. Lint: `genvm-lint check contracts/waypoint.py`
3. Test direct: `pytest tests/direct/ -v`
4. Select a network and deploy: `genlayer deploy`
...
- Contract interactions: `frontend/lib/contracts/Waypoint.ts`
- React hooks: `frontend/lib/hooks/useWaypoint.ts`
