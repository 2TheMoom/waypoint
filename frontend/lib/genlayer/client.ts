...
// Defaults target Bradbury testnet, where Waypoint is deployed.
//
...
// actual read/write client (built from getGenLayerChain() in Waypoint.ts)
 ...
 * Bradbury's own RPC - Waypoint is only ever deployed there, so this
